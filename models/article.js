 ...
 * @returns {*}
 */
articleModel.get = (params={},skip=0,limit=0,count=0) => {
  console.log(JSON.stringify(params))
  return parseInt(count)===1?articleModel.find(params).count():articleModel.find(params).skip(Number(skip)).limit(Number(limit));
};
